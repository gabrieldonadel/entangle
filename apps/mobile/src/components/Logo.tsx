...
/**
 * The two-orb Entangle mark. Mirrors the desktop atom at
 * `apps/desktop/src/components/atoms/Logo.tsx` so both apps share the same
 * visual identity. Dark-theme tokens are baked in (steel-blue accent,
 * highlight ellipses).
 */
