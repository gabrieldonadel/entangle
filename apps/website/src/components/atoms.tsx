...
export const AndroidIcon = ({ size = 18 }: IconProps) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="currentColor">
    <path d="M6 9.5h12c.55 0 1 .45 1 1V18c0 .55-.45 1-1 1h-1v2.25c0 .69-.56 1.25-1.25 1.25S14.5 21.94 14.5 21.25V19h-5v2.25c0 .69-.56 1.25-1.25 1.25S7 21.94 7 21.25V19H6c-.55 0-1-.45-1-1v-7.5c0-.55.45-1 1-1zM3.75 9.5c.69 0 1.25.56 1.25 1.25v5.5c0 .69-.56 1.25-1.25 1.25S2.5 16.94 2.5 16.25v-5.5c0-.69.56-1.25 1.25-1.25zm16.5 0c.69 0 1.25.56 1.25 1.25v5.5c0 .69-.56 1.25-1.25 1.25s-1.25-.56-1.25-1.25v-5.5c0-.69.56-1.25 1.25-1.25zM15.53 2.16l.92-1.6a.3.3 0 0 0-.11-.41.3.3 0 0 0-.41.11l-.94 1.62A7.4 7.4 0 0 0 12 1.25c-1.06 0-2.06.22-2.99.63L8.07.26a.3.3 0 0 0-.41-.11.3.3 0 0 0-.11.41l.92 1.6A6.55 6.55 0 0 0 5 8.5h14a6.55 6.55 0 0 0-3.47-6.34zM9 6.25a.75.75 0 1 1 0-1.5.75.75 0 0 1 0 1.5zm6 0a.75.75 0 1 1 0-1.5.75.75 0 0 1 0 1.5z" />
  </svg>
);
